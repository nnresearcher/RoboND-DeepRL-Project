...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      printf("ArmPlugin - triggering EOE, episode has exceeded %i frames\n", maxEpisodeLength);
		rewardHistory = REWARD_LOSS*0.2f;
		newReward     = true;
		endEpisode    = true;
	}
		...
		*/ 
		...
		if(!(gripBBox.min.z <= groundContact))
		{
			...
			if( episodeFrames > 1 )
			{
				...
				avgGoalDelta = (avgGoalDelta*0.9f) + (distDelta*(1.0f - 0.9f));//first
				rewardHistory = avgGoalDelta;//first
				//rewardHistory=exp(-distGoal); //second
